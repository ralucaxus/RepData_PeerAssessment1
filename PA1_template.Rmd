...
average_d_act       <- tapply( activity$steps,
                               list(activity$interval, activity$day_type),
                               mean, na.rm=T)
daily_activity      <- data.frame( interval=as.integer(row.names(average_d_act)),
                              average_d_act)

daily_activity.long <- melt( daily_activity, id.vars="interval", 
                             variable.name="day_type", value.name="steps")

ggplot(data=daily_activity.long, aes(interval, steps)) +
